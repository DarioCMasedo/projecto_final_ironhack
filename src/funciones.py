...
def alineacion_433(valor_total,edad):
    try:
        ...
        annotation = ax.annotate(medios['short_name'][2], (89, 40), fontsize=40, ha='center')
        annotation = ax.annotate(delanteros['short_name'][0], (60, 68), fontsize=40, ha='center')
        annotation = ax.annotate(delanteros['short_name'][1], (89, 12), fontsize=40, ha='center')
        annotation = ax.annotate(delanteros['short_name'][2], (89, 68), fontsize=40, ha='center')
...
def alineacion_343(valor_total,edad):
    try: 
        ...
        fig, ax = pitch.draw(figsize=(25, 25))
        annotation = ax.annotate(porteros['short_name'][0], (5, 40), fontsize=40, ha='center')
        annotation = ax.annotate(defensas['short_name'][0], (89, 40), fontsize=40, ha='center')
        annotation = ax.annotate(defensas['short_name'][1], (24, 40), fontsize=40, ha='center')
        annotation = ax.annotate(defensas['short_name'][2], (32, 12), fontsize=40, ha='center')
        annotation = ax.annotate(medios['short_name'][0], (32, 68), fontsize=40, ha='center')
